...
<body>
    <form id="form1" runat="server">
        <div style="height: 1784px; text-align: center;">
            ...
            <asp:Button ID="LoadButton" runat="server" BorderStyle="Outset" Font-Bold="False" Font-Italic="True" ForeColor="#660033" Text="Load data" OnClick="LoadButton_Click" CssClass="buttonStyle" />
&nbsp;<asp:CustomValidator ID="DataValidator" runat="server" ErrorMessage="You must load data first!" Font-Bold="False" Font-Italic="True" ForeColor="#333399">*</asp:CustomValidator>
